...
export default function WhatsAppFloat({ number }: { number: string }) {
  ...
  return (
    <a
      ...
      className="group fixed right-4 bottom-4 z-40 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-[0_10px_30px_rgba(0,0,0,0.25)] transition-transform hover:scale-105 sm:right-6 sm:bottom-6"
